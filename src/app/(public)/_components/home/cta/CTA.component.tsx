...
export default function CTA() {
  return (
    <section className="relative  sm:py-16 lg:py-20 bg-gradient-to-br from-green-700 via-green-700 to-green-700 py-20 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10 pointer-events-none">
        ...
        <motion.div className="absolute top-1/2 left-1/2 w-16 h-16 bg-white rounded-full" animate={{ y: [0, -20, 0, 10, 0] }} transition={{ duration: 4, repeat: Infinity, repeatType: 'loop', ease: 'easeInOut' }} />
      </div>
      ...
      <div className="relative max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        ...
        <Link href="/auth/signup">
          <Button size="lg" className="bg-white text-primary hover:bg-gray-100 text-base sm:text-lg px-6 sm:px-8 py-2 sm:py-3 font-bold hover:scale-110 transition-transform duration-300">
            JOIN NOW!
          </Button>
        </Link>
      </div>
