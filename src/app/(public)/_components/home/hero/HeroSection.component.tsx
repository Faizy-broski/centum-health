...
export default function HeroSection() {
  ...
  return (
    <section className="relative  py-12 sm:py-16 lg:py-24 bg-gradient-to-br from-green-50 via-white to-gray-100 py-20 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 mb-4">
            Take Control of Your <span className="text-green-600">Health Journey</span>
          </h1>
          ...
          <AnimatePresence mode="wait">
            <motion.h1
              ...
              className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-green-600 mb-4"
          ...
          <div className="mt-4 h-1 bg-gradient-to-r from-transparent via-green-500 to-transparent rounded-full animate-pulse mb-6"></div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-12 sm:mb-16">
            <Link href={user?.isLoggedIn ? paths.customerDashboard() : paths.signup()}>
              <Button size="lg" className="bg-green-600 hover:bg-green-700 text-base sm:text-lg px-6 sm:px-8 py-2 sm:py-3 w-full sm:w-auto hover:scale-105 transition-transform duration-300">
            ...
            <Link href={paths.howItWorks()}>
              <Button
                ...
                size="lg"
                className="text-base sm:text-lg px-6 sm:px-8 py-2 sm:py-3 w-full sm:w-auto hover:border-black hover:bg-black hover:text-white transition-colors duration-300 hover:scale-105 transition-transform"
              >
                Learn More
              </Button>
            </Link>
